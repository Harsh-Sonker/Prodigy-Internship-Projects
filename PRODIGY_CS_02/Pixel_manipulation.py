...
class ImageEncryptionGUI:
    ...
    def encrypt_image_op(self, image_path, encryption_key):
        ...
        encrypted_array = np.mod(image_array + encryption_key, 256)  # Ensure values stay within 0-255 range
    ...
    def decrypt_image_op(self, encrypted_image_path, decryption_key):
        ...
        decrypted_array = np.mod(encrypted_array - decryption_key, 256)  # Ensure values stay within 0-255 range
